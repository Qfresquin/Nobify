...
cmake_path(APPEND P sub OUTPUT_VARIABLE P_APP)
cmake_path(REMOVE_FILENAME P_APP OUTPUT_VARIABLE P_DIR)
cmake_path(REMOVE_EXTENSION P LAST_ONLY OUTPUT_VARIABLE P_NOEXT)
cmake_path(REPLACE_EXTENSION P_NOEXT .log OUTPUT_VARIABLE P_LOG)
cmake_path(NORMAL_PATH P_LOG OUTPUT_VARIABLE P_NORM)
cmake_path(COMPARE "a//b" EQUAL "a/b" P_EQ)
cmake_path(HAS_EXTENSION P P_HAS_EXT)
add_executable(misc_app main.c)
target_compile_definitions(misc_app PRIVATE P_EXT=${P_EXT} P_STEM_LAST=${P_STEM_LAST} P_DIR=${P_DIR} P_NORM=${P_NORM} P_EQ=${P_EQ} P_HAS_EXT=${P_HAS_EXT})
#@@ENDCASE
...
link_libraries(debug m optimized pthread general dl plain)
...
set(CACHED_X cache_seed CACHE STRING "seed")
