...
TEST(evaluator_event_ir_taxonomy_is_frozen) {
    ...
    static const Event_Kind_Contract_Row expected_kinds[] = {
        ...
        {EVENT_TEST_PROPERTY_MUTATE, EVENT_FAMILY_TEST, "test_property_mutate", EVENT_ROLE_STATE | EVENT_ROLE_BUILD_SEMANTIC},
        ...
        {EVENT_CPACK_PACKAGE_DECLARE, EVENT_FAMILY_CPACK, "cpack_package_declare", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_CPACK_PACKAGE_ADD_GENERATOR, EVENT_FAMILY_CPACK, "cpack_package_add_generator", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_CPACK_PACKAGE_ARCHIVE_NAME_OVERRIDE, EVENT_FAMILY_CPACK, "cpack_package_archive_name_override", EVENT_ROLE_BUILD_SEMANTIC},
        ...
        {EVENT_TARGET_FILE_SET_DECLARE, EVENT_FAMILY_TARGET, "target_file_set_declare", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_TARGET_FILE_SET_ADD_BASE_DIR, EVENT_FAMILY_TARGET, "target_file_set_add_base_dir", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_SOURCE_MARK_GENERATED, EVENT_FAMILY_BUILD_GRAPH, "source_mark_generated", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_SOURCE_PROPERTY_MUTATE, EVENT_FAMILY_BUILD_GRAPH, "source_property_mutate", EVENT_ROLE_BUILD_SEMANTIC},
        ...
        {EVENT_TARGET_COMPILE_FEATURES, EVENT_FAMILY_TARGET, "target_compile_features", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_EXPORT_INSTALL, EVENT_FAMILY_EXPORT, "export_install", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_EXPORT_BUILD_DECLARE, EVENT_FAMILY_EXPORT, "export_build_declare", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_EXPORT_BUILD_ADD_TARGET, EVENT_FAMILY_EXPORT, "export_build_add_target", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_EXPORT_PACKAGE_REGISTRY, EVENT_FAMILY_EXPORT, "export_package_registry", EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_REPLAY_ACTION_DECLARE, EVENT_FAMILY_BUILD_GRAPH, "replay_action_declare", EVENT_ROLE_RUNTIME_EFFECT | EVENT_ROLE_BUILD_SEMANTIC},
        {EVENT_REPLAY_ACTION_ADD_INPUT, EVENT_FAMILY_BUILD_GRAPH, "replay_action_add_input", EVENT_ROLE_RUNTIME_EFFECT | EVENT_ROLE_BUILD_SEMANTIC},
