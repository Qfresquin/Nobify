...
#define EVAL_COMMAND_REGISTRY(X) \
    ...
    X("FetchContent_Populate", eval_handle_fetchcontent_populate, EVAL_CMD_IMPL_FULL, EVAL_FALLBACK_NOOP_WARN) \
    X("FetchContent_SetPopulated", eval_handle_fetchcontent_setpopulated, EVAL_CMD_IMPL_FULL, EVAL_FALLBACK_NOOP_WARN) \
