...
static void toolchain_model_apply_config(EvalExecContext *ctx,
    ...
    model->explicit_target_platform = explicit_target_system || explicit_target_processor ||
