...
bool eval_handle_execute_process(struct Evaluator_Context *ctx, const Node *node);
bool eval_handle_exec_program(struct Evaluator_Context *ctx, const Node *node);
bool eval_handle_cmake_language(struct Evaluator_Context *ctx, const Node *node);
