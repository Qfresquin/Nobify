...
typedef enum {
    ...
    EVENT_REPLAY_OPCODE_FS_COPY_TREE,
    EVENT_REPLAY_OPCODE_FS_REMOVE,
    EVENT_REPLAY_OPCODE_FS_REMOVE_RECURSE,
    EVENT_REPLAY_OPCODE_FS_RENAME,
    EVENT_REPLAY_OPCODE_FS_CREATE_LINK,
    EVENT_REPLAY_OPCODE_FS_CHMOD,
    EVENT_REPLAY_OPCODE_FS_CHMOD_RECURSE,
