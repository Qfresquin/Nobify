...
BM_Replay_Opcode bm_replay_opcode_from_event(Event_Replay_Opcode opcode) {
    switch (opcode) {
        ...
        case EVENT_REPLAY_OPCODE_FS_COPY_TREE: return BM_REPLAY_OPCODE_FS_COPY_TREE;
        case EVENT_REPLAY_OPCODE_FS_REMOVE: return BM_REPLAY_OPCODE_FS_REMOVE;
        case EVENT_REPLAY_OPCODE_FS_REMOVE_RECURSE: return BM_REPLAY_OPCODE_FS_REMOVE_RECURSE;
        case EVENT_REPLAY_OPCODE_FS_RENAME: return BM_REPLAY_OPCODE_FS_RENAME;
        case EVENT_REPLAY_OPCODE_FS_CREATE_LINK: return BM_REPLAY_OPCODE_FS_CREATE_LINK;
        case EVENT_REPLAY_OPCODE_FS_CHMOD: return BM_REPLAY_OPCODE_FS_CHMOD;
        case EVENT_REPLAY_OPCODE_FS_CHMOD_RECURSE: return BM_REPLAY_OPCODE_FS_CHMOD_RECURSE;
