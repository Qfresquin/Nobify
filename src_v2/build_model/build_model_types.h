...
typedef enum {
    ...
    BM_REPLAY_OPCODE_FS_COPY_TREE,
    BM_REPLAY_OPCODE_FS_REMOVE,
    BM_REPLAY_OPCODE_FS_REMOVE_RECURSE,
    BM_REPLAY_OPCODE_FS_RENAME,
    BM_REPLAY_OPCODE_FS_CREATE_LINK,
    BM_REPLAY_OPCODE_FS_CHMOD,
    BM_REPLAY_OPCODE_FS_CHMOD_RECURSE,
