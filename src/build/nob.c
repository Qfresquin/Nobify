...
int main(int argc, char **argv) {
    ...
    if (argc > 1 && strcmp(argv[1], "test") == 0) {
        ...
        nob_cmd_append(&cmd,
            ...
            "test/test_transpiler_01_suite_core.c",
            "test/test_transpiler_02_suite_targets_codegen.c",
            "test/test_transpiler_03_suite_find_include.c",
            "test/test_transpiler_04_suite_file_io.c",
            "test/test_transpiler_05_suite_cpack.c",
            "test/test_transpiler_06_suite_probes.c",
            "test/test_transpiler_07_suite_ctest_meta.c",
            "test/test_transpiler_08_suite_misc.c",
