...
| `if` | `eval_flow.c` | complete | `partial` | `FLOW`, `TRACE` | `EVENT_FLOW_IF_EVAL`, `EVENT_FLOW_BRANCH_TAKEN` | high | Condition results and selected branch are now emitted semantically. |
