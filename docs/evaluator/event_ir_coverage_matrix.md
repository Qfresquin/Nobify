...
| `project` | `eval_project.c` | complete | `partial` | `PROJECT`, `TRACE` | `EVENT_TRACE_COMMAND_BEGIN`, `EVENT_TRACE_COMMAND_END` | high | Structural project payload is still pending; command remains trace-only for now. |
