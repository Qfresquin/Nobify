...
Compatibility note:
- command-level policy framework is complete for baseline 3.28, and the current live command hooks include `CMP0017`, `CMP0036`, `CMP0048`, `CMP0061`, `CMP0074`, `CMP0077`, `CMP0102`, `CMP0124`, `CMP0126`, `CMP0140`, `CMP0144`, `CMP0152`, and `CMP0153`. Behavior changes gated by other policies remain covered by those commands' own compatibility entries.
